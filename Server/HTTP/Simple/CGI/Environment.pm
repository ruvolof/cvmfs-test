package Server::HTTP::Simple::CGI::Environment;
...
Server::HTTP::Simple::CGI::Environment - a Server::HTTP::Simple mixin to provide the CGI protocol

=head1 DESCRIPTION

This mixin abstracts the CGI protocol out from
L<Server::HTTP::Simple::CGI> so that it's easier to provide your own
CGI handlers with L<Server::HTTP::Simple> which B<don't> use CGI.pm
...
sub setup_environment {
    %ENV = (
        %clean_env,
        SERVER_SOFTWARE   => "Server::HTTP::Simple/$VERSION",
