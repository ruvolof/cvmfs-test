package Server::HTTP::AppServer::Plugin::JsonCrud;
# Plugin for Server::HTTP::AppServer that provides CRUD methods for
...
Server::HTTP::AppServer - Perl extension for blah blah blah
...
Stub documentation for Server::HTTP::AppServer, created by h2xs. It looks like the
