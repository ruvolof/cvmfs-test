package Server::HTTP::AppServer::Plugin::HTTPAuth;
# Plugin for Server::HTTP::AppServer uses HTTP authentication to
...
Server::HTTP::AppServer::Plugin::HTTPAuth - Plugin for Server::HTTP::AppServer uses HTTP authentication to authenticate a client. The authentication works based on a certain handler regex.
...
Plugin for Server::HTTP::AppServer uses HTTP authentication to authenticate a client. 
