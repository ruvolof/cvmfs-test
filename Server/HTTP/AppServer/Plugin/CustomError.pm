package Server::HTTP::AppServer::Plugin::CustomError;
# Plugin for Server::HTTP::AppServer that defines custom error pages
...
Server::HTTP::AppServer::Plugin::CustomError - Plugin for Server::HTTP::AppServer that defines custom error pages for all HTTP error codes.
...
Plugin for Server::HTTP::AppServer that defines custom error pages for all HTTP error codes.
