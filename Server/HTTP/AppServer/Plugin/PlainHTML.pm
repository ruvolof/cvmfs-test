package Server::HTTP::AppServer::Plugin::PlainHTML;
# Plugin for Server::HTTP::AppServer that creates static html pages for
...
Server::HTTP::AppServer::Plugin::PlainHTML - Plugin for Server::HTTP::AppServer that creates static html pages for a given set of database tables to make a website better accessable for search engine crawlers and drive SEO.
...
Plugin for Server::HTTP::AppServer that creates static html pages for a given set 
