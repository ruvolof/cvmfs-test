package Server::HTTP::AppServer::Plugin::Database;
# Plugin for Server::HTTP::AppServer that provides a connection
...
Server::HTTP::AppServer::Plugin::Database - Plugin for Server::HTTP::AppServer that allows easy DBI database access.
